...
def record_best_episode_mp4(
    ...
    ax.set_title(f"Strict REINFORCE | Best Reward: {best_reward:.1f}", fontsize=11)
...
def plot_results(scores: list, avg_scores: list, save_dir: str) -> None:
    ...
    ax.set_title("Strict REINFORCE on LunarLander-v3 (Discrete)")
    ax.legend(loc="lower right")
    ax.grid(True, alpha=0.3)

    plt.tight_layout()
    output_path = os.path.join(save_dir, "training_curves.png")
