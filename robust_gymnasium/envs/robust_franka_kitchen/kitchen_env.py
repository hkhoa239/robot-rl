...
from robust_gymnasium.envs.robust_franka_kitchen.franka_env import FrankaRobot
    ...
    * v0: legacy versions in the [D4RL](https://github.com/Farama-Foundation/D4RL).
    ...
    def step(self, robust_input):
        ...
        if args.noise_factor == "state":
            if args.noise_type == "gauss":
                obs["observation"] = obs["observation"] + random.gauss(args.noise_mu, args.noise_sigma)  # robust setting
            elif args.noise_type == "shift":
                obs["observation"] = obs["observation"] + args.noise_shift
            else:
