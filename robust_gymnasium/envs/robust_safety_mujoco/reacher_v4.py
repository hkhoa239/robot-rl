...
class ReacherEnv(MujocoEnv, utils.EzPickle):
    ...
    Most robust_gymnasium environments just return the positions and velocity of the
    ...
    - *reward_control*: A negative reward for penalising the walker_seed1 if
    ...
    ```
    env = robust_gymnasium.make('Reacher-v4')
    ```

    There is no v3 for Reacher, unlike the robot environments where a v3 and
    beyond take robust_gymnasium.make kwargs such as xml_file, ctrl_cost_weight, reset_noise_scale etc.
