...
class Walker2dEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.xml_file = "walker2d.xml"
        self.xml_file_original = "walker2d_original.xml"
    ...
    def modify_xml(self, file_name, args):
        ...
        if args.noise_factor == "robust_force":
            ...
            if hip_4_motor is not None:
                ...
                print("No motor found for joint 'thigh_joint'")

        if args.noise_factor == "robust_shape":
            # find right_back_leg's geom
            change_shape_mass = root.find(".//body[@name='leg_left']/geom")
            if change_shape_mass is not None:
                ...
                print("No geom found for body 'leg_left'")
