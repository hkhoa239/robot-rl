...
class InvertedPendulumEnv(MujocoEnv, utils.EzPickle):
    ...
    * v5:
        ...
        - Fixed bug: `healthy_reward` was given on every step (even if the Pendulum is unhealthy), now it is only given if the Pendulum is healthy (not terminated) (related [GitHub issue](https://github.com/Farama-Foundation/robust_gymnasium/issues/500)).
