...
try:
    ...
    from robust_gymnasium.envs.utils import mujoco_py_utils
...
try:
    ...
    from robust_gymnasium.envs.utils import mujoco_utils
except ImportError as e:
...
class BaseRobotEnv(GoalEnv):
    ...
    def step(self, robust_input):
        ...
        if args.noise_factor == "state":
            if args.noise_type == "gauss":
                obs["achieved_goal"] = obs["achieved_goal"] + random.gauss(args.noise_mu, args.noise_sigma)  # robust setting
            elif args.noise_type == "shift":
                obs["achieved_goal"] = obs["achieved_goal"] + args.noise_shift
            else:
