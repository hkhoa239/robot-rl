...
from robust_gymnasium.envs.robosuite.environments.manipulation.two_arm_env import TwoArmEnv
from robust_gymnasium.envs.robosuite.models.arenas import TableArena
from robust_gymnasium.envs.robosuite.models.objects import DoorObject
...
class MultiRobustDoor(TwoArmEnv):
    """
    ...
    def __init__(
        ...
        render_camera="birdview",#"frontview", # "camera" names = ('frontview', 'birdview', 'agentview', 'sideview', 'robot0_robotview', 'robot0_eye_in_hand', 'robot1_robotview', 'robot1_eye_in_hand')
        ...
        table_robot_back_distance = -0.55 # 0.5 # -0.35
        ...
        table_robot_left_distance = -0.2 # -1 #-0.2
    ...
    def _load_model(self):
        ...
        for robot, offset in zip(self.robots, (-0.15, 0.2)):
        ...
        mujoco_arena.set_origin([0, 0, 0]) # mujoco_arena.set_origin([1, 0, 0])
