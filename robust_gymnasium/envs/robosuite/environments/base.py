...
import robust_gymnasium.envs.robosuite
import robust_gymnasium.envs.robosuite.macros as macros
import robust_gymnasium.envs.robosuite.utils.sim_utils as SU
from robust_gymnasium.envs.robosuite.renderers.base import load_renderer_config
from robust_gymnasium.envs.robosuite.utils import OpenCVRenderer, SimulationError, XMLError
from robust_gymnasium.envs.robosuite.utils.binding_utils import MjRenderContextOffscreen, MjSim
...
def make(env_name, *args, **kwargs):
    """
    Instantiates a robust_gymnasium.envs.robosuite environment.
    This method attempts to mirror the equivalent functionality of gym.make in a somewhat sloppy way.
    Args:
        env_name (str): Name of the robust_gymnasium.envs.robosuite environment to initialize
    ...
    Returns:
        MujocoEnv: Desired robust_gymnasium.envs.robosuite environment
    Raises:
...
class MujocoEnv(metaclass=EnvMeta):
    ...
    Args:
        ...
        hard_reset (bool): If True, re-loads model, sim, and render object upon a reset call, else,
            only calls sim.reset and resets all robust_gymnasium.envs.robosuite-internal variables
    ...
    def initialize_renderer(self):
        ...
        if self.renderer == "mujoco" or self.renderer == "default":
            ...
            from robust_gymnasium.envs.robosuite.renderers.nvisii.nvisii_renderer import NVISIIRenderer
    ...
    def reset(self):
        ...
        # Reset necessary robust_gymnasium.envs.robosuite-centric variables
        self._reset_internal()
        self.sim.forward()
    ...
    def edit_model_xml(self, xml_str):
        ...
        path = os.path.split(robust_gymnasium.envs.robosuite.__file__)[0]
        ...
        for elem in all_elements:
            ...
            ind = max(loc for loc, val in enumerate(old_path_split) if val == "robust_gymnasium.envs.robosuite")  # last occurrence index
