...
# Image Convention
# robust_gymnasium.envs.robosuite (Mujoco)-rendered images are based on the OpenGL coordinate frame convention, whereas many downstream
...
# File logging is written to /tmp/robust_gymnasium.envs.robosuite_{time}_{pid}.log by default
FILE_LOGGING_LEVEL = None

# Override with macros from macros_private.py file, if it exists
try:
    from robust_gymnasium.envs.robosuite.macros_private import *
    # print("import success------------------!")
except ImportError:
    # print("import another package-----------:")
    from robust_gymnasium.envs import robosuite
    from robust_gymnasium.envs.robosuite.utils.log_utils import ROBOSUITE_DEFAULT_LOGGER

    # import robust_robosuite
    # from robust_gymnasium.envs.robosuite.utils.log_utils import robosuite_DEFAULT_LOGGER
